...
public enum ReferenceEdiMappingEnum {
	...
	AVAILABLEVFOR_ORDER("availableForOrder", 85, 94),	
	...
	ReferenceEdiMappingEnum(String fieldName, int startRange, int endRange){
