...
create table error (id bigint not null auto_increment, agent varchar(255), exception text, hostname varchar(255), ip varchar(255), message text, timestamp datetime, primary key (id));
...
create table kos_notification (id integer not null auto_increment, action varchar(255), creation_date datetime, error text, error_date datetime, kubik_id integer not null, processed_date datetime, status varchar(255), type varchar(255), primary key (id));
